    ...
    extends AbstractColorStyleType
{
    ...
    @XmlElementRef(name = "LineStyleSimpleExtensionGroup", namespace = "http://www.opengis.net/kml/2.2", type = JAXBElement.class, required = false)
    protected List<JAXBElement<?>> lineStyleSimpleExtensionGroup;
     ...
     * 
     */
    public List<JAXBElement<?>> getLineStyleSimpleExtensionGroup() {
        if (lineStyleSimpleExtensionGroup == null) {
            lineStyleSimpleExtensionGroup = new ArrayList<JAXBElement<?>>();
        }
