...
import net.opengis.kml.ex.AbstractTourPrimitiveType;
import net.opengis.kml.ex.AnimatedUpdateType;
import net.opengis.kml.ex.FlyToType;
import net.opengis.kml.ex.LatLonQuadType;
import net.opengis.kml.ex.MultiTrackType;
import net.opengis.kml.ex.PlaylistType;
import net.opengis.kml.ex.SoundCueType;
import net.opengis.kml.ex.TourControlType;
import net.opengis.kml.ex.TourType;
import net.opengis.kml.ex.TrackType;
import net.opengis.kml.ex.ViewerOptionsType;
import net.opengis.kml.ex.WaitType;
