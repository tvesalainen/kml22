 ...
 * generated in the net.opengis.kml.ex package. 
...
public class ObjectFactory {
    ...
    private final static QName _OuterWidth_QNAME = new QName("http://www.google.com/kml/ext/2.2", "outerWidth");
    ...
    private final static QName _Option_QNAME = new QName("http://www.google.com/kml/ext/2.2", "option");
    ...
    private final static QName _LabelVisibility_QNAME = new QName("http://www.google.com/kml/ext/2.2", "labelVisibility");
    ...
    private final static QName _OuterColor_QNAME = new QName("http://www.google.com/kml/ext/2.2", "outerColor");
    private final static QName _TourControl_QNAME = new QName("http://www.google.com/kml/ext/2.2", "TourControl");
    private final static QName _ViewerOptions_QNAME = new QName("http://www.google.com/kml/ext/2.2", "ViewerOptions");
    private final static QName _DelayedStart_QNAME = new QName("http://www.google.com/kml/ext/2.2", "delayedStart");
    ...
    private final static QName _PhysicalWidth_QNAME = new QName("http://www.google.com/kml/ext/2.2", "physicalWidth");
    ...
    private final static QName _AltitudeOffset_QNAME = new QName("http://www.google.com/kml/ext/2.2", "altitudeOffset");
    private final static QName _Wait_QNAME = new QName("http://www.google.com/kml/ext/2.2", "Wait");
    private final static QName _DrawOrder_QNAME = new QName("http://www.google.com/kml/ext/2.2", "drawOrder");
    ...
    private final static QName _HorizFov_QNAME = new QName("http://www.google.com/kml/ext/2.2", "horizFov");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.opengis.kml.ex
     * 
     */
    ...
    /**
     * Create an instance of {@link ViewerOptionsType }
     * 
     */
    ...
    public JAXBElement<Float> createOuterWidth(Float value) {
        return new JAXBElement<Float>(_OuterWidth_QNAME, Float.class, null, value);
    }
    ...
    public JAXBElement<Boolean> createLabelVisibility(Boolean value) {
        return new JAXBElement<Boolean>(_LabelVisibility_QNAME, Boolean.class, null, value);
    }
    ...
    public JAXBElement<byte[]> createOuterColor(byte[] value) {
        return new JAXBElement<byte[]>(_OuterColor_QNAME, byte[].class, null, ((byte[]) value));
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ViewerOptionsType }{@code >}}
     * 
     */
    ...
    public JAXBElement<ViewerOptionsType> createViewerOptions(ViewerOptionsType value) {
        return new JAXBElement<ViewerOptionsType>(_ViewerOptions_QNAME, ViewerOptionsType.class, null, value);
    }
    ...
    public JAXBElement<Float> createPhysicalWidth(Float value) {
        return new JAXBElement<Float>(_PhysicalWidth_QNAME, Float.class, null, value);
    }
    ...
    public JAXBElement<BigInteger> createDrawOrder(BigInteger value) {
        return new JAXBElement<BigInteger>(_DrawOrder_QNAME, BigInteger.class, null, value);
    }
